...
extern "C"
{
	...
	{
		while ((*s1 != '\0') && (tolower(*(unsigned char *)s1) ==
	...
	int strncasecmp(const char *s1, const char *s2, unsigned int n)
	{
		if (n == 0)
			return 0;
		while ((n-- != 0) && (tolower(*(unsigned char *)s1) ==
							  tolower(*(unsigned char *)s2)))
		{
			if (n == 0 || *s1 == '\0' || *s2 == '\0')
				return 0;
...
{
	char **image;
	download_web_page("http://www.baidu.com/", 80, "http://www.baidu.com/index.html", NULL, NULL, NULL, 10, image);
	return 0;
}