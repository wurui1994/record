...
// Wrapper for MediaInfoWidget Library
// Please see MediaInfoWidget.h for help
//
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
...
/***************************************************************************/
/*! \file MediaInfoDll.h
\brief DLL wrapper for MediaInfoWidget.h.

DLL wrapper for MediaInfoWidget.h \n
    Can be used for core and core++\n
...
/** @brief A 'new' MediaInfoWidget interface, return a Handle, don't forget to delete it after using it*/
MEDIAINFO_EXP void*             __stdcall MediaInfo_New (); /*you must ALWAYS call MediaInfo_Delete(Handle) in order to free memory*/
/** @brief A 'new' MediaInfoWidget interface (with a quick init of useful options : "**VERSION**;**APP_NAME**;**APP_VERSION**", but without debug information, use it only if you know what you do), return a Handle, don't forget to delete it after using it*/
...
/** @brief Delete a MediaInfoWidget interface*/
MEDIAINFO_EXP void              __stdcall MediaInfo_Delete (void* Handle);
/** @brief Wrapper for MediaInfoLib::MediaInfoWidget::Open (with a filename)*/
MEDIAINFO_EXP size_t            __stdcall MediaInfo_Open (void* Handle, const wchar_t* File);
/** @brief Wrapper for MediaInfoLib::MediaInfoWidget::Open (with a buffer) */
...
/** @brief Wrapper for MediaInfoLib::MediaInfoWidget::Open (with a buffer, Init) */
...
/** @brief Wrapper for MediaInfoLib::MediaInfoWidget::Set */
...
/** @brief Wrapper for MediaInfoLib::MediaInfoWidget::Output_Buffer_Get */
...
#ifdef __cplusplus
//DLL core++ wrapper for core functions
