...
size_t Core::Menu_File_Open_Files_Continue (const String &FileName)
{
    ...
    //Preparing to fill MediaInfoWidget with a buffer
    ...
    do
    {
        ...
        //Sending the buffer to MediaInfoWidget
...
#define toString(s) std::to_wstring(s)
#else
...
void Core::Menu_Debug_Details (float Value)
{
	...
	MI->Option(__T("Inform"), __T("Details;") + toString(Value));
}
